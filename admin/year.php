...
$oPage->setTitle(Translations::get('website_name') . ' | ' . Translations::get('admin_page_year_title') . ' '. date('Y'));
...
function createContent() {
	...
	// title
	$ret = '<h2>' . Misc::createYearSwitcher($year,Settings::get('first_year'), date("Y")) . '</h2>';
