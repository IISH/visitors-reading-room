...
class class_field_string extends class_field {
	...
	function form_field($row, $m_form, $required_typecheck_result = 0 ) {
		...
		$inputfield = "<input name=\"FORM_::FIELDNAME::\" id=\"FORM_::FIELDNAME::\" type=\"text\" value=\"::VALUE::\" size=\"::SIZE::\" ::CLASS::>::POST::";
		...
		$inputfield = str_replace("::POST::", $this->get_addpostfield(), $inputfield);
